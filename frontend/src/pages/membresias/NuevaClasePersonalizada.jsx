...
const NuevaClasePersonalizada = () => {
    ...
    const cargarClientes = async () => {
        try {
            ...
            const response = await ClasePersonalizadaService.obtenerClientes();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await ClasePersonalizadaService.crearClasePersonalizada(claseData);
...
export default NuevaClasePersonalizada;
